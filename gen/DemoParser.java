...
public class DemoParser extends Parser {
	...
	public static class TokensContext extends ParserRuleContext {
		...
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof DemoListener ) ((DemoListener)listener).enterTokens(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof DemoListener ) ((DemoListener)listener).exitTokens(this);
		}
	}
	...
	public final TokensContext tokens() throws RecognitionException {
		...
		try {
			...
			_la = _input.LA(1);
			while ((((_la) & ~0x3f) == 0 && ((1L << _la) & ((1L << T1) | (1L << T2) | (1L << T3) | (1L << T4) | (1L << T5) | (1L << T6) | (1L << WS))) != 0)) {
				{
				{
				setState(2);
				matchWildcard();
